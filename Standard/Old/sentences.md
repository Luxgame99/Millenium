Question:
Who(Subject) What(Verb) To(Subject) What(Object) When(Time) Optional
...
WhoWhatToWhatWhen
you consume that or you give me that

examples:

i like to draw
i like to do draw
megh tagae rothe tessa


we can talk about it later
we can (hyp. now)(eigener terminus), to together speak over this unknown-time
we [i prefer]could, do together talk over this othertime
vagh me'tapei, rothe yemec requa emme se yoksor

when do we talk?
we do talk wann ?
vegh rote requa sor haa
